const plugins = [
	{
		name: 'yoast-premium',
		title: __( 'Yoast SEO Premium', 'wp-plugin-web' ),
		description: __( 'SEO made easy!', 'wp-plugin-web' ),
		price: '99',
		cta: __( 'Buy Now', 'wp-plugin-web' ),
		url:
			'https://yoa.st/bh-premium?utm_source=wp-admin%2Fadmin.php%3Fpage%3Dweb%23%2Fplugins&utm_medium=WEB_PLUGIN',
		img: 'https://cdn.hiive.space/bluehost/plugin/yoast-seo-premium.png',
	},
	{
		name: 'yoast-woo',
		title: __( 'Yoast WooCommerce SEO', 'wp-plugin-web' ),
		description: __(
		...
		cta: __( 'Buy Now', 'wp-plugin-web' ),
		url:
			'https://yoa.st/bh-woo-seo?utm_source=wp-admin%2Fadmin.php%3Fpage%3Dweb%23%2Fplugins&utm_medium=WEB_PLUGIN',
		img: 'https://cdn.hiive.space/bluehost/plugin/yoast-seo-woo.png',
	},
	{
		name: 'constant-contact',
		title: __( 'Constant Contact forms for WordPress', 'wp-plugin-web' ),
		description: __(
